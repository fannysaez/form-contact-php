...
* [**composer install**]```bash composer install``` : installe toutes les dépendances définies dans le fichier composer.json.
* [**composer require**](composer require/package): ajoute une nouvelle dépendance au projet (par exemple, composer require phpmailer/phpmailer).
